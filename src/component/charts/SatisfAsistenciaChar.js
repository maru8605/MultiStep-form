...
const SatisfAsistenciaChar = () => {
  const chartData = useRecoilValue(getDataCharts);
  const data = chartData['satisfAtencion-asistencia']; //mesaEntrada;
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del servicio de atención - Asistencia',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Nivel de satisfacción del servicio de atención - Asistencia',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatisfAsistenciaChar;
