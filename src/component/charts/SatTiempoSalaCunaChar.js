...
const SatTiempoSalaCunaChar = () => {
  const chartData = useRecoilValue(getDataCharts);
  const data = chartData['satisfTiempo-salaCuna'];
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del tiempo insumido en el proceso de atención - Sala Cuna',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Nivel de satisfacción del tiempo insumido en el proceso de atención - Sala Cuna',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatTiempoSalaCunaChar;
