...
const SatisfAtencion0800Char = () => {
  const chartData = useRecoilValue(getDataCharts);
  const data = chartData['satisfAtencion-0800'];
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del servicio de atención - 0800',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
...
export default SatisfAtencion0800Char;
