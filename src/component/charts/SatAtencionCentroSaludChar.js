...
const SatAtencionCentroSaludChar = () => {
  const chartData = useRecoilValue(getDataCharts);
  const data = chartData['satisfAtencion-centroDeSalud'];
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del servicio de atención - Centro de Salud',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Nivel de satisfacción del servicio de atención - Centro de Salud',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatAtencionCentroSaludChar;
