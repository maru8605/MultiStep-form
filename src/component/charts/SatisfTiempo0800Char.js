...
const SatisfTiempo0800Char = () => {
  const chartData = useRecoilValue(getDataCharts);
  const data = chartData['satisfTiempo-0800'];
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del tiempo insumido en el proceso de atención - 0800',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Nivel de satisfacción del tiempo insumido en el proceso de atención - 0800',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatisfTiempo0800Char;
