...
const SatAtencionConstatacionesChar = () => {
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del servicio de atención - Constataciones',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Nivel de satisfacción del servicio de atención - Constataciones',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatAtencionConstatacionesChar;
