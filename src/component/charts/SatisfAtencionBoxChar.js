...
const SatisfAtencionBoxChar = () => {
  ...
  const options = {
    ...
    title: {
      text: 'Mesa de entrada - Calidad de las instalaciones del establecimiento',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Mesa de entrada - Calidad de las instalaciones del establecimiento',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatisfAtencionBoxChar;
