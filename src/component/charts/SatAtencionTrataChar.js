...
const SatAtencionTrataChar = () => {
  const chartData = useRecoilValue(getDataCharts);
  const data = chartData['satisfAtencion-trataDePersonas'];
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del servicio de atención - Trata de personas',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Nivel de satisfacción del servicio de atención - Trata de personas',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatAtencionTrataChar;
