...
const SatAtencionBtnAntipanico = () => {
  const chartData = useRecoilValue(getDataCharts);
  const data = chartData['satisfAtencion-botonAntipanico'];
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del servicio de atención - Botón Antipánico',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Nivel de satisfacción del servicio de atención - Botón Antipánico',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatAtencionBtnAntipanico;
