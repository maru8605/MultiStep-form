...
const SatTiempoRefugioChar = () => {
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del tiempo insumido en el proceso de atención - Refugio',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Nivel de satisfacción del tiempo insumido en el proceso de atención - Refugio',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatTiempoRefugioChar;
