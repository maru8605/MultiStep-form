...
const SatAtencionBecasChar = () => {
  const chartData = useRecoilValue(getDataCharts);
  const data = chartData['satisfAtencion-becas'];
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del servicio de atención - Becas',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Nivel de satisfacción del servicio de atención - Becas',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatAtencionBecasChar;
