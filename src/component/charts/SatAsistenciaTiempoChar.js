...
const SatAsistenciaTiempoChar = () => {
  const chartData = useRecoilValue(getDataCharts);
  const data = chartData['satisfTiempo-asistencia'];
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del tiempo insumido en el proceso de atención - Asistencia',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Nivel de satisfacción del tiempo insumido en el proceso de atención - Asistencia',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatAsistenciaTiempoChar;
