...
const SatisfAtencionMesaChar = () => {
  ...
  const options = {
    ...
    title: {
      text: 'Nivel de satisfacción del servicio de atención - Mesa de Entrada/Box',
      align: 'left',
      verticalAlign: 'top',
      y: 50,
      style: {
    ...
    series: [
      {
        name: 'Nivel de satisfacción del servicio de atención - Mesa de Entrada/Box',
        colorByPoint: true,
        type: 'pie',
        innerSize: '50%',
        data: serieData,
...
export default SatisfAtencionMesaChar;
